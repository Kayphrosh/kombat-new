      ...
      <div className="livebets">
        {liveBetsData.length === 0 ? (
          ...
          liveBetsData.map((livebet) => (
            <div className="livebet" key={livebet._betId?.toString()}>
              ...
              <div className="content">
                <div className="players-info">
                  <div className="player">
                    <Image
                      src={getAvatar(livebet.actor1)}
                      alt="Actor 1"
                      width={50}
                      height={50}
                    />
                    <p>{getDisplayName(livebet.actor1)}</p>
                  </div>
                  <span>VS</span>
                  <div className="player">
                    <Image
                      src={getAvatar(livebet.actor2)}
                      alt="Actor 2"
                      width={50}
                      height={50}
                    />
                    <p>{getDisplayName(livebet.actor2)}</p>
                  </div>
                </div>
                ...
                <div className="cta">
                  <Link href={`/livebet/${livebet._betId}`}>
                    <button className="arrowButton" title="Enter Arena">
                      <ArrowIcon />
                    </button>
                  </Link>
                </div>
